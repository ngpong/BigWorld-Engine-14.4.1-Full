 ...
 */
void {{ className }}::set_{{ property.name }}( 
 ...
 */
void {{ className }}::reset_{{ property.name }}( 
		const {{ property.type|ctype }} & oldValue )
{
 ...
 */
void {{ className }}::setNested_{{ property.name }}( 
		const NestedPropertyChange::Path & path, 
		const {{ property.type|ctype }} & oldValue )
{
	this->set_{{ property.name }}( oldValue );
}
 ...
 *	indices. 
 */
void {{ className }}::setSlice_{{ property.name }}( 
		const NestedPropertyChange::Path & path,
