...
## Requires(pre):
## Requires(post):
Requires: gcc, gcc-c++, gdb, make, python-devel, mysql-devel, python-devel, subversion, SDL-devel, SDL_image-devel, MySQL-python, sqlite-devel, readline-devel, gdbm-devel, bzip2-devel, ncurses-devel, strace, binutils-devel, patch, unzip
## Obsoletes:
## Conflicts:
