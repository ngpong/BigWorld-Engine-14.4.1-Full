...
"""
This class implements a smooth moving gui control.  The gui
control must have a matrix shader attached called transform
since we refer directly to "self.component.transfor" in the SmoothMover.
"""
