...
class LanguageIndicator( PyGUIBase ):
	...
	def sizeToFit( self ):
		...
		self.component.width = w * Utils.getHPixelScalar()
		self.component.widthMode = oldMode
		
		oldMode = self.component.heightMode
		self.component.heightMode = "PIXEL"
		self.component.height = h * Utils.getVPixelScalar()
	...
	@staticmethod
	def create( autoSize=True, padding=5, square=True ):
