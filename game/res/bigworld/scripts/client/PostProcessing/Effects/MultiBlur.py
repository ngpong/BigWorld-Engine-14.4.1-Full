...
def multiBlur(filterMode = 0, ):
	...
	#blur and downsample the just performed blur and downsample.
	#TODO : check that horiz.blur into a larger RT then vert.blur into smaller RT doesn't
	#make an asymmetrical blur.
	...
	e = Effect()
	e.name = "Multi Blur"
	phases = [bh1,bv1,bh2,bv2,bh3,bv3,bh3a,bv3a]
	e.phases = phases
	return e
