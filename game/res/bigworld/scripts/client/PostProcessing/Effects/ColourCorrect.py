...
saturation = MaterialFloatProperty( _hsvColourCorrectEffectName, -1, "saturation", primary = True )
brightness = MaterialFloatProperty( _hsvColourCorrectEffectName, -1, "brightness" )

types = [	"system/maps/post_processing/colour_correct.bmp",
		"system/maps/post_processing/s curve/s_curve.bmp",
		"system/maps/post_processing/blood_rage/blood_rage.bmp",
		"system/maps/post_processing/heat/heat.bmp",
		"system/maps/post_processing/night vision/night_vision.bmp",
		"system/maps/post_processing/old film/old_film.bmp",
