#All filter taps are stored as (du, dv, weight)
...
def gaussianBlur24Tap( horiz, width = 1.0 ):
	...
	if horiz:
		...
		samples.append( [ -8.6 * width, 0.0, 0.3790] )
		...
		samples.append( [0.0,   0.0 * width, 0.0000] )
		samples.append( [0.0,   0.0 * width, 0.0000] )
