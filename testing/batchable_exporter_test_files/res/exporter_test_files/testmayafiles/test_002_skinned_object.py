...
def run():
	#ModelEditor.loadModel( "exporter_test_files/testmayafiles/test_002_skinned_object.model" )
...
def captureModelAndQuitCoroutine():
	...
	animName = ModelEditor.addAnim( "exporter_test_files/testmayafiles/test_002_skinned_object_anim.animation" )
